...
\confidentiality{公开}
\UDC{}
\title{面向人机交互的物理情境感知技术研究}
\displaytitle{面向人机交互的物理情境感知技术研究}
\author{党标}
\zhdate{\zhtoday}
\entitle{Smartphone based}%Smartphone based user context sensing key technology research}
\enauthor{DANG Biao}
\endate{\entoday}
\subject{计算机科学与技术}
\ensubject{Computer Science and Technology}
\researchfield{无线网络与移动计算}
\supervisor{王晓东\quad{}教授}
\cosupervisor{} % 没有就空着
